package org.fleen.whelmer.whelmerVideoCreationSystems.w_test037_tweakedbasefreqfactorandcelldatacap_soundisprettygood;
...
public class AudioRenderer0 implements AudioRenderer{
  ...
  static final double 
    BASEFREQUENCYFACTOR=800,
    DELTAEXPONENT=1.2,//1.6,
    CELLDELTACAP=17.0,//14.0
    STROBEDRONEFILTER=-1.0;//get rid of the strobe's influence upon the sound. We don't want it.
