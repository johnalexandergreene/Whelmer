package org.fleen.whelmer.whelmerVideoCreationSystems.w_test24_asymmetric_periodic;
...
public class Rings0 extends ArrayList<Ring_Simple> implements Rings{
  ...
  public void conditionallyCreateRings(){
    ...
    if((whelmer.time+266)%201==0)
      add(new Ring_PureSine(whelmer,Ring_PureSine.INWARD,0.0012,0.42,Ring_PureSine.NEGATIVE));
